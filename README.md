...
- Green City - Improve recycling with incentives.  Charge for garbage bags.  Toxic waste (batteries), recycling, and compost need to be delivered to a station.  Garbage bags will cost money.  Stations would have a drop off station which requires an ID card.  You receive credits for the drop off which can be applied toward free garbage bags.  Trash Cash.  Currently 52% of waste goes to land fills.
- Wave of the Future.  Energy is in higher demand than ever before.  Alternative sources are a better solution than fossil fuels.  Renewable energy sources inlcude wind, solar, and and hydro.  Another alternative is wave power.  A buoy would pull a rope connected to a generator.
